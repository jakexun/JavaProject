    ...
    public static void main(String[] args) {
        try{
            ...
            for (int i = 0;i<times;i++){
                int datanumber=adm.monitoring_checking(get_data_path,filepath,row,column,k,iteration_times);
                statistica.Statisticing(filepath,fitness_file,datanumber,column,k);
            }
        }catch (Exception e) {
            e.printStackTrace();
        }
