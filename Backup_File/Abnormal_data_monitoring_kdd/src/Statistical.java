...
public class Statistical{
    ...
    try {
        ...
        Tools t = new Tools();
        String filepath = "compare_test_data.txt";
        String[][] databf = t.Initia_data(filepath, 2000, 43);
        int p = 0;
        int n = 0;
        ...
        String filenew = "compare_test_data.txt";
        int tn = 0;
        int number =rwd.Read_result_number(filenew);
        ...
        int tp = p - fn;
        int fp = n - tn;
        BufferedWriter out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("run_result_min.txt", true)));
